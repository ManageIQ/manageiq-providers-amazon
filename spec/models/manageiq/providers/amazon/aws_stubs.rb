module AwsStubs
  ...
  def test_counts(scaling = nil)
    ...
    {
      :load_balancer_count                             => scaling * 6,
      :availability_zone_count                         => scaling * 5,
      :instance_vpc_count                              => scaling * 6,
      :instance_ec2_count                              => scaling * 6,
      :image_count                                     => scaling * 6,
      :key_pair_count                                  => scaling * 6,
      :stack_count                                     => scaling * 6,
      :stack_resource_count                            => scaling * 6,
      ...
      :floating_ip_count                               => scaling * 6,
      :security_group_count                            => scaling * 6,
