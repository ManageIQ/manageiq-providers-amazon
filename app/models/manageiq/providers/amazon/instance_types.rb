...
module ManageIQ::Providers::Amazon::InstanceTypes
  ...
  AVAILABLE_TYPES = {
    ...
    "x1e.xlarge"  => {
      ...
      :vcpu                    => 4,
      :ebs_only                => false,
      :instance_store_size     => 120.0.gigabytes,
      :instance_store_volumes  => 1, # SSD
      :architecture            => [:x86_64],
      :virtualization_type     => [:hvm],
      :network_performance     => :up_to_10_gigabit,
    ...
    "x1e.8xlarge" => {
      ...
      :vcpu                    => 32,
      :ebs_only                => false,
      :instance_store_size     => 960.0.gigabytes,
      :instance_store_volumes  => 1, # SSD
      :architecture            => [:x86_64],
      :virtualization_type     => [:hvm],
      :network_performance     => :up_to_10_gigabit,
    ...
    "h1.2xlarge"  => {
      ...
      :vcpu                    => 8,
      :ebs_only                => false,
      :instance_store_size     => 2000.0.gigabytes,
    ...
    "h1.8xlarge"  => {
      ...
      :memory                  => 128.0.gigabytes,
      :vcpu                    => 32,
      :ebs_only                => false,
      :instance_store_size     => 8000.0.gigabytes,
    ...
    "h1.16xlarge" => {
      ...
      :vcpu                    => 64,
      :ebs_only                => false,
      :instance_store_size     => 16000.0.gigabytes,
